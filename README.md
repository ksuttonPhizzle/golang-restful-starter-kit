...
[![GoDoc](https://godoc.org/github.com/ksuttonPhiz/golang-restful-starter-kit?status.png)](http://godoc.org/github.com/ksuttonPhiz/golang-restful-starter-kit)
[![Build Status](https://travis-ci.org/ksuttonPhiz/golang-restful-starter-kit.svg?branch=master)](https://travis-ci.org/ksuttonPhiz/golang-restful-starter-kit)
[![Coverage Status](https://coveralls.io/repos/github/ksuttonPhiz/golang-restful-starter-kit/badge.svg?branch=master)](https://coveralls.io/github/ksuttonPhiz/golang-restful-starter-kit?branch=master)
[![Go Report](https://goreportcard.com/badge/github.com/ksuttonPhiz/golang-restful-starter-kit)](https://goreportcard.com/report/github.com/ksuttonPhiz/golang-restful-starter-kit)
...
`$GOPATH/ksuttonPhiz/golang-restful-starter-kit` directory:
...
* move the directory `$GOPATH/github.com/ksuttonPhiz/golang-restful-starter-kit` to `$GOPATH/github.com/abc/xyz`
* do a global replacement of the string `github.com/ksuttonPhiz/golang-restful-starter-kit` in all of
